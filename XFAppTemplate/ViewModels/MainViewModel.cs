...
namespace XFAppTemplate.ViewModels
{
	public class MainViewModel : ViewModelBase
    {
		...
		public MainViewModel(IPopupService popupService, IPageDialogService pageDialogService, INavigationService navigationService, IEventAggregator eventAggregator)
